...
class Contacts_ByNameAndTitle(AbstractMultiMapIndexCreationTask):
    ...
    # region Step_2
    class IndexEntry:
        def __init__(self, contact_name: str = None, contact_title: str = None, collection: object = None):
    ...
    class ProjectedEntry(IndexEntry):
        def __init__(
            self, contact_name: str = None, contact_title: str = None, collection: object = None, phone: str = None
        ):
...
class MultiMapReduceIndexCustomizedFields(Example):
    def run(self, run_params: RunParams):
        name_prefix = run_params.name_prefix or "Michael"
        title_prefix = run_params.title_prefix or "Sales"
        ...
        with self.document_store_holder.store().open_session() as session:
            contacts = list(
                ...
                .where_starts_with("contact_name", name_prefix)
                .where_starts_with("contact_title", title_prefix)
