...
class HighlightQueryResultsCustomized(Example):
    def run(self, run_params: RunParams):
        fragment_length = run_params.fragment_length or 100
        ...
        with self.document_store_holder.store().open_session() as session:
            ...
            employee_results = list(
                ...
                .highlight("Title", fragment_length, fragment_count, __title_highlight_callback, tags_to_use1)
                .highlight("Notes", fragment_length, fragment_count, __notes_highlight_callback, tags_to_use2)
            ...
            if len(employee_results) > 0:
                employee_id = employee_results[0].Id
