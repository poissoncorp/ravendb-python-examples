...
class RunParams(RunParamsBase):
    def __init__(self, start: str = None, end: str = None, middle: str = None, number_of_results: int = None):
        self.start = start
        self.end = end
        self.middle = middle
...
class FtsQueryWildcards(Example):
    def run(self, run_params: RunParams):
        ...
        number_of_results = run_params.number_of_results
        ...
        with self.document_store_holder.store().open_session() as session:
            ...
            # endregion
            # region Step_4
            last_fm_query = last_fm_query.take(number_of_results).order_by("Artist")
            # endregion
            # region Step_5
